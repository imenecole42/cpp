...
{
	if ( this->_hit == 0 )
		std::cout << std::endl << "ClapTrap " << this->_name << " can't attack... he's dead !" << std::endl;
...
{ 
	if ( this->_hit == 0 )
		std::cout << std::endl << "... but ClapTrap R3PO " << this->_name << " can't take damages... he's dead !" << std::endl;
	else
	{
		std::cout << "ClapTrap  " << this->_name;
...
{
	if ( this->_hit == 0 )
		std::cout << std::endl << "ClapTrap " << this->_name << " can't fix himself... he's dead !" << std::endl;
	else if ( this->_energy == 0 )
